...
#define pFND_SDAT_Pin GPIO_PIN_0
#define pFND_SDAT_GPIO_Port GPIOC
#define pFND_SCLK_Pin GPIO_PIN_1
#define pFND_SCLK_GPIO_Port GPIOC
#define pFND_LATCH_Pin GPIO_PIN_2
#define pFND_LATCH_GPIO_Port GPIOC
